package ExcelApachePOI.MavenExcel;
...
public class AccessExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\Admin\\Desktop\\abc.xlsx");
		@SuppressWarnings("resource")
		XSSFWorkbook myexcelbook = new XSSFWorkbook(fis);
		XSSFSheet mysheet=    myexcelbook.getSheet("Sales");
		...
		for(int i=1;i<rowcount;i++)
		{
		  ...
		  {       
			   ...
			   if (CellType.NUMERIC.equals(mycell.getCellTypeEnum()))
